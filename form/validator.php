...
class Validator{
	...
	public function wright_to_db($from, $subject, $text, $mail){
		...
		//$query = "INSERT INTO `question` VALUES (NULL,'".$from ."','".'Тема: '.$subject.' Вопрос: '.$text."','".$mail."','',0);";
		$query = "INSERT INTO `question` VALUES (NULL,'".$from ."','".$subject.' '.$text."','".$mail."','',0);";
		mysql_query($query);
		$res = mysql_insert_id();
		return $res;
		//return $from." написал: ".$subject.' c текстом: '.$text." c мыла: ".$mail;
	}
	 ...
	 * @return	bool
	 */	
	public function valid_captcha($str,$name){
